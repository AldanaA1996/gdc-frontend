...
export async function strapiRequest<T>(
	...
	let url = `/${entity}`
	const params = options.params || { populate: "*" }
	...
	return defaultStrapiRequest<T>(method, url, options.data ?? undefined, config)
  }
...
export function findEntity<T>(entity: string, params: StrapiFindParams = {}) {
  return strapiRequest< {data: T[]; meta: any }> (entity, "find", { params })
}
