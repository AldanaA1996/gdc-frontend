...
export const createUser = (data: Partial<User>): ApiResponse<User> =>
  strapiRequest<User>(USERS, "create", {
    data,
  });
...
export const updateUser = async (
  ...
  for (const { entity } of relationActions) {
    ...
    if (Array.isArray(populate)) {
      populate = Object.keys(mediaFields).map(
        (field) => `${entity.singular}.${f}`
      );
    }
  }
...
export const getUserBy = (params: StrapiFindParams) =>
