...
import AddMaterialForm from '@/components/addMaterial-form';
    ...
    <Layout>
      <div className="flex flex-col  min-h-screen py-2 gap-4">
        <div className="bg-gray-100 p-6 rounded-lg shadow-md mb-4">
          ...
          <p className="mt-2 text-gray-600">Una ayuda para manejar su ingreso y egreso de materiales al deposito</p>
        </div>
      ...
      <div className="flex-end flex-1 text-end justify-end bg-white p-6 rounded-lg shadow-md">
          ...
          <p className="mt-2 text-gray-600">Esta app esta en etapas de creacion por una programadora sin experiencia, por favor sea paciente con ella.</p>
        </div>
      </div>
    </Layout>
